...
namespace Quanlyphuongtien
{
    ...
    public partial class ViewLogPage : ContentPage
    {
        ...
        public ViewLogPage(UserLogin iUserLogin)
        {
                    ...
                    GestureRecognizers = {
                        new TapGestureRecognizer
                        {
                            Command = new Command(async()=>{
                                //DisplayAlert("OK", logData.Log.IndexOf(item)+"_1","OK");
                                indexRun = logData.Log.IndexOf(item);
                                BinDetailRun();
                                await listDetailViewLog.Off();
                            })
                        }
                    },
                });
        ...
        private void InitMap(RelativeLayout mainLayout)
        {
            Device.BeginInvokeOnMainThread(() =>
            {
                ...
                {
                    speedRunSlider.TranslationX = -15;
                }
